...
def extract_connection_data():
    ...
    for i in range(10):
        ...
        connection_data_1.extend(rank_array_c[0])
        connection_data_2.extend(rank_array_c[1])
        connection_data_3.extend(rank_array_c[2])
        connection_data_4.extend(rank_array_c[3])
        connection_data_5.extend(rank_array_c[4])
        connection_data_6.extend(rank_array_c[5])
        connection_data_7.extend(rank_array_c[6])
        connection_data_8.extend(rank_array_c[7])
        connection_data_9.extend(rank_array_c[8])
    student_sub_score = []
    for i in range(100):
